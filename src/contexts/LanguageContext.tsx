...
const translations = {
  pt: {
    ...
    "hero.description":
      "Experimente os sabores autênticos da Itália no coração de Lisboa.",
    "hero.cta": "Reservar uma mesa",

    // Menu Section
    "menu.title": "Nosso Menu",
    "menu.description":
      "Nosso restaurante captura a essência da gastronomia italiana: ingredientes frescos, receitas preciosas transmitidas por gerações e uma profunda paixão pelos sabores autênticos.",
    ...
    "room.description":
      "Nosso restaurante, localizado no coração de Alfama, oferece uma atmosfera acolhedora e autêntica onde o charme português se mistura com a elegância italiana em um espaço tradicional e refinado.",
    "room.rating": "no TheFork",
    "room.review.thefork":
      "Um ambiente acolhedor, com pratos autênticos e deliciosos.",
    "room.review.tripadvisor":
      "Um ambiente tradicional, complementado por um serviço atencioso e personalizado.",
    ...
    // Footer
    "footer.experience":
      "Uma experiência culinária italiana autêntica no coração de Lisboa.",
  ...
  en: {
    ...
    "hero.description":
      "Experience the authentic flavors of Italy in the heart of Lisbon.",
    "hero.cta": "Book a table",

    // Menu Section
    "menu.title": "Our Menu",
    "menu.description":
      "Our restaurant captures the essence of Italian gastronomy: fresh ingredients, cherished recipes passed down through generations, and a deep passion for authentic flavors.",
    "menu.discover": "Discover our menu",
    "menu.fresh.pasta": "Fresh Pasta",
    "menu.wines": "Wines",
    "menu.desserts": "Desserts",
    "menu.modal.title": "Our Menu",
    ...
    "room.description":
      "Our restaurant, located in the heart of Alfama, offers a warm and authentic atmosphere where Portuguese charm meets Italian elegance in a traditional and refined space.",
    "room.rating": "on TheFork",
    "room.review.thefork":
      "A warm and welcoming atmosphere, with authentic and delicious dishes.",
    "room.review.tripadvisor":
      "A traditional setting, complemented by attentive and personalized service.",
    ...
    // Footer
    "footer.experience":
      "An authentic Italian culinary experience in the heart of Lisbon.",
